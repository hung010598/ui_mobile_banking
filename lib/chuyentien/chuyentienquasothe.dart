...
import 'package:emobilebanking/chuyentien/xacthucthe.dart';
...
class CKTheNoiBo extends StatelessWidget {
          ...
          children: <Widget>[
            new Expanded(
              ...
              child: new Container(
                ...
                child: new Text("CK nội bộ qua số thẻ"),
              ),
            ),
            new Expanded(
              flex: 16,
                          ...
                          new Expanded(
                            child: Container(
                              ...
                              child: GestureDetector(
                                ...
                                onTap: (){
                                  Navigator.of(context).push(
                                      new MaterialPageRoute(builder: (context) => XacThucThe()));
                                },
                              ),
                            ),
                          )

...
class XacThucLienNganHang extends StatelessWidget {
                ...
                children: <Widget>[
                  new Expanded(
                    ...
                    child: new Container(
                      ...
                      child: new Text("Xác thực CK liên ngân hàng"),
                    ),
                  ),
                  new Expanded(
                    flex: 16,
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Ngân hàng đích", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Tài khoản đích", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                      ...
                                      child: GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(
                                              new MaterialPageRoute(builder: (context) => TabChuyenTien())
                                          );
                                        },
                                        child: new Container(
                                          alignment: Alignment.center,
                                ...
                                new Expanded(
                                  child: Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      onTap: (){
                                        Navigator.of(context).push(
                                            new MaterialPageRoute(builder: (context) => KetQua()));
                                      },
                                    ),
                                  ),
                                )

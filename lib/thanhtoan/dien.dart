...
import 'package:emobilebanking/thanhtoan/xacnhandien.dart';
...
class Dien extends StatelessWidget {
                ...
                children: <Widget>[
                  new Expanded(
                    ...
                    child: new Container(
                      ...
                      child: new Text("Thanh toán tiền điện"),
                    ),
                  ),
                  new Expanded(
                    flex: 16,
                                ...
                                new Expanded(
                                  child: Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      onTap: (){
                                        Navigator.of(context).push(
                                            new MaterialPageRoute(builder: (context) => XacNhanDien()));
                                      },
                                    ),
                                  ),
                                )
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: ListView(
                            children: <Widget>[
                              ListTile(
                                leading: Image.asset("assets/evn.jpg"),
                                title: Text("EVN 3"),
                              ...
                              ListTile(
                                leading: Image.asset("assets/evn.jpg"),
                                title: Text("EVN miền trung"),

                                onTap: (){
                                  setState(() {
                                    _visible = false;
                                    nganhang = "EVN miền trung";
                                    _color = Colors.transparent;
                                  });
                                },
                              ),
                              ListTile(
                                leading: Image.asset("assets/evn.jpg"),
                                title: Text("EVN Hồ Chí Minh"),

                                onTap: (){
                                  setState(() {
                                    _visible = false;
                                    nganhang = "EVN Hồ Chí Minh";
                                    _color = Colors.transparent;
                                  });
                                },
                              ),
                              ...
                              ListTile(
                                leading: Image.asset("assets/evn.jpg"),
                                title: Text("EVN miền bắc"),

                                onTap: (){
                                  setState(() {
                                    _visible = false;
                                    nganhang = "EVN miền bắc";
                                    _color = Colors.transparent;
                                  });
                                },
                              ),
                              ListTile(
                                leading: Image.asset("assets/evn.jpg"),
                                title: Text("EVN miền nam"),

                                onTap: (){
                                  setState(() {
                                    _visible = false;
                                    nganhang = "EVN miền nam";
                                    _color = Colors.transparent;
                                  });
                                },
                              ),

...
import 'package:emobilebanking/thanhtoan/xacnhandttruoc.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
void main() {
  runApp(DTDDTraTruoc());
}
class DTDDTraTruoc extends StatelessWidget {
                              ...
                              new Expanded(
                                child: Container(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    onTap: (){
                                      Navigator.of(context).push(
                                          new MaterialPageRoute(builder: (context) => XacThucDTDD()));
                                    },
                                  ),
                                ),
                              )

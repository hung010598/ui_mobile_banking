...
class XacNhanMaybay extends StatelessWidget {
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Mã thanh toán", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Điểm đi", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerRight,
                                          child: Text("A", style: TextStyle(color: Colors.black, fontSize: 16.0)),
                                        ),
                                      )
                                    ],
                                  ),
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Điểm đến", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerRight,
                                          child: Text("B", style: TextStyle(color: Colors.black, fontSize: 16.0)),
                                        ),
                                      )
                                    ],
                                  ),
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Thời gian cất cánh", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerRight,
                                          child: Text("00:00 10-08-2020", style: TextStyle(color: Colors.black, fontSize: 16.0)),
                                        ),
                                      )
                                    ],
                                  ),

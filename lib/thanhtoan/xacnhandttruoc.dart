...
class XacThucDTDD extends StatelessWidget {
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerLeft,
                                          child: Text("Số điện thoại", style: TextStyle(color: Colors.grey)),
                                        ),
                                      ),
                                      Expanded(
                                        child: Container(
                                          alignment: Alignment.centerRight,
                                          child: Text("0123456789", style: TextStyle(color: Colors.black, fontSize: 16.0)),
                                        ),
                                      )
                                    ],
                                  ),

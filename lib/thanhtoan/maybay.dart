...
import 'package:emobilebanking/thanhtoan/xacnhanmaybay.dart';
...
class VeMayBay extends StatelessWidget {
                ...
                children: <Widget>[
                  new Expanded(
                    ...
                    child: new Container(
                      ...
                      child: new Text("Thanh toán vé máy bay"),
                    ),
                  ),
                  new Expanded(
                    flex: 16,
                                ...
                                new Expanded(
                                  child: Container(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      onTap: (){
                                        Navigator.of(context).push(
                                            new MaterialPageRoute(builder: (context) => XacNhanMaybay()));
                                      },
                                    ),
                                  ),
                                )
                        ...
                        Container(
                          ...
                          child: ListView(
                            children: <Widget>[
                              ...
                              ListTile(
                                leading: Image.asset("assets/jetstarpacific.png"),

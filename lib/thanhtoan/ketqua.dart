...
class KetQuaThanhToan extends StatelessWidget {
                ...
                children: <Widget>[
                  new Expanded(
                    ...
                    child: new Container(
                      ...
                      child: new Text("Kết quả giao dịch"),
                    ),
                  ),
                  new Expanded(
                    flex: 16,
                          ...
                          new Container(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                Text("Giao dịch thành công", style: TextStyle(fontSize: 24.0,color: Colors.black ),)
                              ],
                            ),
                          ),
                          new Container(
